...
public class GuestController {
   ...
   /* private final GuestService guestService;
    ...
    public String getGuests(Model model){
        List<Guest> guests = this.guestServiceProxy.retrieveGuests();
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public ModelAndView addGuest(HttpServletRequest request, Model model, @ModelAttribute GuestDTO guestModel){
        Guest guest = this.guestServiceProxy.addAGuest(guestModel);
    ...
    public String getGuest(Model model, @PathVariable long id){
        Guest guest = this.guestServiceProxy.getAGuest(id);
        model.addAttribute("guest", guest);
        return "guest-view";
    }
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public String updateGuest(Model model, @PathVariable long id, @ModelAttribute GuestDTO guestModel){
        Guest guest = this.guestServiceProxy.updateAGuest(id, guestModel);
        model.addAttribute("guest", guest);
